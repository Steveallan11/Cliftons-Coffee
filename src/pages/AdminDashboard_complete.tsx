...
type TabType = 'overview' | 'analytics' | 'menu' | 'orders' | 'bookings' | 'messages' | 'customers'
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className={`${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-xl p-6 border shadow-sm`}>
                  <h3 className={`text-lg font-semibold ${darkMode ? 'text-white' : 'text-gray-800'} mb-4 flex items-center space-x-2`}>
                    ...
                    {orders.slice(0, 5).map((order) => (
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className={`font-medium ${darkMode ? 'text-white' : 'text-gray-800'}`}>#{order.id}</p>
                            <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>{order.customer_name}</p>
                          </div>
                        </div>
                        <div className="text-right">
                          <p className={`font-medium ${darkMode ? 'text-white' : 'text-gray-800'}`}>{formatCurrency(order.total_amount)}</p>
                ...
                <div className={`${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-xl p-6 border shadow-sm`}>
                  ...
                  <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                              {booking.party_size} guests at {booking.booking_time}
                            </p>
                          </div>
                    ...
                    {bookings.filter(booking => 
                      ...
                      <p className={`text-center py-8 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>No bookings for today</p>
                    )}
                  </div>
                </div>
              </div>
                  ...
                  <table className="w-full">
                    <thead className={darkMode ? 'bg-gray-700' : 'bg-gray-50'}>
                      <tr>
                        ...
                        <th className={`text-left p-4 font-medium ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>Amount</th>
                        <th className={`text-center p-4 font-medium ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>Status</th>
                        <th className={`text-left p-4 font-medium ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>Date</th>
                    ...
                    <tbody>
                      {orders.map((order, index) => (
                        ...
                        >
                          <td className="p-4">
                            <span className={`font-medium ${darkMode ? 'text-white' : 'text-gray-800'}`}>#{order.id}</span>
                          </td>
                          <td className="p-4">
                            <div>
                          ...
                          <td className="p-4">
                            <span className={`capitalize ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>{order.order_type}</span>
                          </td>
                          <td className="p-4">
                            <span className={`font-medium ${darkMode ? 'text-white' : 'text-gray-800'}`}>{formatCurrency(order.total_amount)}</span>
                          </td>
                          ...
                          <td className="p-4">
                            <span className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>{formatDate(order.created_at)}</span>
                          </td>
                          <td className="p-4 text-center">
                            <button
                              onClick={(e) => {
                  ...
                  <table className="w-full">
                    <thead className={darkMode ? 'bg-gray-700' : 'bg-gray-50'}>
                      <tr>
                        ...
                        <th className={`text-left p-4 font-medium ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>Date & Time</th>
                        <th className={`text-center p-4 font-medium ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>Status</th>
                        <th className={`text-center p-4 font-medium ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>Actions</th>
                      </tr>
                    </thead>
                    <tbody>
                      {bookings.map((booking, index) => (
                        ...
                        >
                          <td className="p-4">
                            <span className={`font-medium ${darkMode ? 'text-white' : 'text-gray-800'}`}>#{booking.id}</span>
                          </td>
                          <td className="p-4">
                            <div>
                          ...
                          <td className="p-4 text-center">
                            <span className={`font-medium ${darkMode ? 'text-white' : 'text-gray-800'}`}>{booking.party_size}</span>
                          </td>
                          <td className="p-4">
                            <div>
                              <div className={`font-medium ${darkMode ? 'text-white' : 'text-gray-800'}`}>{formatDate(booking.booking_date)}</div>
                              <div className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>{booking.booking_time}</div>
                            </div>
                          </td>
                          <td className="p-4 text-center">
          ...
          {activeTab === 'menu' && (
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                ...
                <button className="px-4 py-2 bg-[#9CAF88] text-white rounded-lg hover:bg-[#8A9F78] transition-colors flex items-center space-x-2">
              ...
              <div className={`${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-lg shadow-sm border p-6`}>
                <div className="text-center py-12">
                  ...
                  <h3 className={`text-lg font-semibold ${darkMode ? 'text-gray-400' : 'text-gray-500'} mb-2`}>Menu Management</h3>
                  <p className={`${darkMode ? 'text-gray-500' : 'text-gray-600'}`}>Menu management features will be implemented here</p>
                  <p className={`text-sm ${darkMode ? 'text-gray-600' : 'text-gray-500'} mt-2`}>Add, edit, and organize your menu items and categories</p>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="space-y-6">
              ...
              <div className={`${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-lg shadow-sm border p-6`}>
                <div className="text-center py-12">
                  ...
                  <h3 className={`text-lg font-semibold ${darkMode ? 'text-gray-400' : 'text-gray-500'} mb-2`}>Customer Management</h3>
                  <p className={`${darkMode ? 'text-gray-500' : 'text-gray-600'}`}>Customer profiles and analytics coming soon</p>
                  <p className={`text-sm ${darkMode ? 'text-gray-600' : 'text-gray-500'} mt-2`}>View customer history, preferences, and loyalty points</p>
                </div>
              </div>
            </div>
          )}
